...
El valor se valida antes de pedir la etiqueta (que el courier cobra): un costo negativo o que no es un número responde 400 sin haber llamado a nadie. Un despacho sin costo deja el que hubiera.
